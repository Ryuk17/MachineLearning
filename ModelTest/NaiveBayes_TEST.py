...
trainData = pd.read_table('./train.txt',header=None,encoding='gb2312',delim_whitespace=True)
testData = pd.read_table('./test.txt',header=None,encoding='gb2312',delim_whitespace=True)
