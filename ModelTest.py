...
trainData = pd.read_table('../data/train.txt',header=None,encoding='gb2312',delim_whitespace=True)
testData = pd.read_table('../data/test.txt',header=None,encoding='gb2312',delim_whitespace=True)
trainLabel = np.array(trainData.pop(3))
trainData = np.array(trainData)
testLabel = np.array(testData.pop(3))
testData = np.array(testData)

# self-Model detection performance
...
# sklearn-Model detection performance
