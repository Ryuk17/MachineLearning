...
trainData = np.array(pd.read_table('../dataset/dataset4/train.txt', header=None, encoding='gb2312', delim_whitespace=True))
testData = np.array(pd.read_table('../dataset/dataset4/test.txt', header=None, encoding='gb2312', delim_whitespace=True))
